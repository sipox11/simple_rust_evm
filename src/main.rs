...
fn main() {
    ...
    let code: String = String::from("602560056089602C01020360005260206000f3"); // Calculate (5*(137+44) - 37) and return result from memory (offset 0). Expected result 868
    ...
    let (success, return_data) = execution_ctx.result();
    println!("===================================================");
    if success {
        println!("Successful execution! Return value: {:?}", return_data);
    } else {
        println!("Execution reverted! Revert message: {:?}", return_data);
    }
    println!("===================================================");
}
